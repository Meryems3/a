    ...
    if not is_valid_date(date_obj):
        ...
        def taux(date_obj):
            ...
            if response.status_code == 200:
                ...
                # Trouver la table souhaitée (vous devrez inspecter la structure HTML pour cela)
                table = soup.find('table')  # Remplacez 'table' par le nom de la balise HTML de la table

                # Utiliser pandas pour lire la table
